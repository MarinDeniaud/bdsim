...
namespace GMAD {
  ...
  template void Parser::Add<FinalStateBiasing, FastList<FinalStateBiasing> >();
...
void Parser::Overwrite(const std::string& objectName)
{
  ...
  // element, atom, colour, crystal, coolingchannel, field, laser, material, physicsbiasing, finalstatebiasing, placement,
